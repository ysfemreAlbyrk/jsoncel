          ...
          <div className="flex flex-col lg:flex-row items-center justify-center space-y-8 lg:space-y-0 lg:space-x-16 mb-12">
            ...
            <div className="flex items-center">
              <div className="lg:hidden">
                <MoveDown className="h-10 w-10 text-gray-400 dark:text-gray-600" />
              </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <div className=" w-32 h-24 bg-gradient-to-br from-purple-100 to-indigo-100 dark:from-purple-900/20 dark:to-indigo-900/20 rounded-2xl flex items-center justify-center mb-4 shadow-lg border border-purple-200 dark:border-purple-800 hover:scale-105 transition-transform duration-300">
            ...
            <div className="flex flex-col items-center">
              ...
              {/* Desktop - Stack */}
              <div className="hidden lg:block relative w-24 h-64 mb-4">
              ...
              {/* Mobile - Side by Side */}
              <div className="lg:hidden flex flex-wrap justify-center gap-3 mb-4">
                {outputFormats.map((format, index) => (
                  <div
                    key={format.name}
                  ...
                  >
                    <div
                      className={`w-24 h-20 ${format.bgColor} rounded-xl flex flex-col items-center justify-center shadow-lg border border-opacity-20 border-gray-300 dark:border-gray-600`}
                    >
                      <format.icon className={`w-5 h-5 ${format.color} mb-1`} />
                      <span className="text-xs font-semibold text-gray-900 dark:text-white">
                        {format.name}
                      </span>
                    </div>
